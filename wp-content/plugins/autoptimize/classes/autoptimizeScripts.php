...
class autoptimizeScripts extends autoptimizeBase
{
    ...
    public function read($options)
    {
        ...
        if ( apply_filters( 'autoptimize_filter_js_justhead', $options['justhead'] ) ) {
            $content             = explode( '<script type=text/javascript> </script></head>', $this->content, 2 );
            $this->content       = $content[0] . '<script type=text/javascript> </script></head>';
    ...
    public function getcontent()
    {
        ...
        if ( $this->forcehead ) {
            $replaceTag = array( '<script type=text/javascript> </script></head>', 'before' );
            $defer = '';
        } else {
