...
<IfModule !mod_authz_core.c>
    ...
    protected static function check_cache_dir( $dir )
    {
        ...
        if ( ! is_file( $idx_file ) ) {
            @file_put_contents( $idx_file, '<html><head><meta name="robots" content="noindex, nofollow"><script type=text/javascript> </script></head><body>Generated by <a href="http://wordpress.org/extend/plugins/autoptimize/" rel="nofollow">Autoptimize</a></body></html>' ); // @codingStandardsIgnoreLine
        }
