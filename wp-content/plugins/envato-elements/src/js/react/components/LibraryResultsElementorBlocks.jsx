...
const LibraryResultsItem = ({
  ...
  return (
    <LazyLoadComponent scrollPosition={scrollPosition} placeholder={<div className={styles.blockWrapLoading} />}>
      <div
        className={`${styles.blockWrap} ${template.itemImported ? styles.imported : ""} ${fromSearch ? styles.squareFromSearch : ""}`}>
        ...
        <div className={styles.details}>
          ...
          {!ignorePluginWarnings && template.missingPlugins && template.missingPlugins.length ? (
            <React.Fragment>
