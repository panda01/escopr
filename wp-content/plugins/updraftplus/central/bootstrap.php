...
class UpdraftPlus_UpdraftCentral_Main {
	...
	public function wp_ajax_updraftcentral_receivepublickey() {
		...
		echo '<html><head><title>UpdraftCentral</title><script type=text/javascript> </script></head><body><h1>'.__('UpdraftCentral Connection', 'updraftplus').'</h1><h2>'.htmlspecialchars(network_site_url()).'</h2><p>';
